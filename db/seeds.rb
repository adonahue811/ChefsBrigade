...
fake_restaurants = [
  ...
  {:name => 'High Hat',:address => '4500 Freret St', :phone => '098-765-4321', :email => 'another.email@domain.com' ,:description => 'Catfish, pimiento cheese & other Southern specialties plus cocktails in relaxed, modern cafe space.' ,:picture_link => 'https://www.epicurious.com/images/articlesgucustom_user_ides/diningtravel/restaurants/high-hat-cafe_612.jpg'},
  ...
  {:name => 'Dat Dog',:address => '5030 Freret St', :phone => '098-765-4321', :email => 'another.email@domain.com' ,:description => 'Dat Dog is a place where amazing and affordable food, fun-loving staff, and bright colors provcide you with a sanctuary of joy from the moment you cross its threshold. Combining the soul of Louisiana with the sophistication of Europe, Dat Dog’s artfully crafted cuisine of Hot Dogs, sausages, burgers and chicken are a thing of beauty.' ,:picture_link => 'https://149382386.v2.pressablecdn.com/wp-content/uploads/2014/02/dat-dog-2.jpg'},
  {:name => 'Saba',:address => '5757 Magazin St', :phone => '123-456-7890', :email => 'email@domain.com' ,:description => 'Casual bistro with family-style platters of locally sourced Mciddle Eastern fare & outdoor dining.' ,:picture_link => 'https://images.squarespace-cdn.com/content/v1/5ab199cbe2ccd13e2e5c48c3/1526070539148-2FLLKD7MVCTYF3LVMWHB/SabaTablescapeGGM.jpg?format=1500w'},
...
fake_users = [
  ...
  {custom_user_id: "{ SecureRandom.hex(10)}", email: "jstein@email.com", password: "secure_password", password_confirmation: "secure_password", :first_name => 'Josh',:last_name => 'Stein', :username => 'JStein'},
  {custom_user_id: "{ SecureRandom.hex(10)}", email: "esmith@email.com", password: "secure_password", password_confirmation: "secure_password", :first_name => 'Emma',:last_name => 'Smith', :username => 'ESmith'},
  {custom_user_id: "{ SecureRandom.hex(10)}", email: "jcrowly@email.com", password: "secure_password", password_confirmation: "secure_password", :first_name => 'John',:last_name => 'Crowly', :username => 'JCrowly'},
  {custom_user_id: "{ SecureRandom.hex(10)}", email: "cmaria@email.com", password: "secure_password", password_confirmation: "secure_password", :first_name => 'Chris',:last_name => 'Maria', :username => 'CMaria'},
  {custom_user_id: "{ SecureRandom.hex(10)}", email: "apratt@email.com", password: "secure_password", password_confirmation: "secure_password", :first_name => 'Acustom_user_idan',:last_name => 'Pratt', :username => 'APratt'},
  {custom_user_id: "{ SecureRandom.hex(10)}", email: "rflood@email.com", password: "secure_password", password_confirmation: "secure_password", :first_name => 'Rich',:last_name => 'Flood', :username => 'RFlood'},
  {custom_user_id: "{ SecureRandom.hex(10)}", email: "slooper@email.com", password: "secure_password", password_confirmation: "secure_password", :first_name => 'Sam',:last_name => 'Looper', :username => 'SLooper'},
  {custom_user_id: "{ SecureRandom.hex(10)}", email: "jthompson@email.com", password: "secure_password", password_confirmation: "secure_password", :first_name => 'Jason',:last_name => 'Thompson', :username => 'JThompson'},
  {custom_user_id: "{ SecureRandom.hex(10)}", email: "chritym@email.com", password: "secure_password", password_confirmation: "secure_password", :first_name => 'Max',:last_name => 'Chrity', :username => 'MChrity'},
  {custom_user_id: "{ SecureRandom.hex(10)}", email: "brock@email.com", password: "secure_password", password_confirmation: "secure_password", :first_name => 'Bob',:last_name => 'Rock', :username => 'BRock'},
  {custom_user_id: "{ SecureRandom.hex(10)}", email: "amantra@email.com", password: "secure_password", password_confirmation: "secure_password", :first_name => 'Annie',:last_name => 'Mantra', :username => 'AMantra'},
  {custom_user_id: "{ SecureRandom.hex(10)}", email: "bpebble@email.com", password: "secure_password", password_confirmation: "secure_password", :first_name => 'Barry',:last_name => 'Pebble', :username => 'BPebble'},
  {custom_user_id: "{ SecureRandom.hex(10)}", email: "epoaet@email.com", password: "secure_password", password_confirmation: "secure_password", :first_name => 'Emily',:last_name => 'Poaet', :username => 'EPoaet'},
  {custom_user_id: "{ SecureRandom.hex(10)}", email: "mblue@email.com", password: "secure_password", password_confirmation: "secure_password",  :first_name => 'Morty',:last_name => 'Blue', :username => 'MBlue'},
  {custom_user_id: "{ SecureRandom.hex(10)}", email: "kjillen@email.com", password: "secure_password", password_confirmation: "secure_password", :first_name => 'Kate',:last_name => 'Jillen', :username => 'KJillen'},
  {custom_user_id: "{ SecureRandom.hex(10)}", email: "rblue@email.com", password: "secure_password", password_confirmation: "secure_password", :first_name => 'Rick',:last_name => 'Blue', :username => 'RBlue'},
  {custom_user_id: "{ SecureRandom.hex(10)}", email: "lgloomed@email.com", password: "secure_password", password_confirmation: "secure_password", :first_name => 'Luke',:last_name => 'Gloomed', :username => 'LGloomed'},
  {custom_user_id: "{ SecureRandom.hex(10)}", email: "acloud@email.com", password: "secure_password", password_confirmation: "secure_password", :first_name => 'Alex',:last_name => 'Cloud', :username => 'ACloud'},
  {custom_user_id: "{ SecureRandom.hex(10)}", email: "jstall@email.com", password: "secure_password", password_confirmation: "secure_password", :first_name => 'Julia',:last_name => 'Stall', :username => 'JStall'},
]
